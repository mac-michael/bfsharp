...
namespace BFsharp
{
    ...
    public abstract partial class EntityBase : INotifyPropertyChanged, IEntityBase
#if NET
        ,IDataErrorInfo
#endif
#if SILVERLIGHT
        ...
        public string this[string columnName]
        {
            get
            {
                var message = string.Join(Environment.NewLine,
                                          ((IEntityBase)this).Extensions.BrokenRules.Where(r => r.Severity == BrokenRuleSeverity.Error)
...
{
    [DataContract(IsReference = true)]
    public abstract partial class EntityBase<T> : INotifyPropertyChanged, IEntityBase
#if NET
        ,IDataErrorInfo
#endif
#if SILVERLIGHT
