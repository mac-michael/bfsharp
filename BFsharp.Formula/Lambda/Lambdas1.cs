...
namespace BFsharp.Formula
{
    ...
    public class CompilableLambda<T1>
    {
        ...
        {
            return Compiler.Compile<Func<T1>>(formula, Definition);
        }
    ...
    public class CompilableLambda<T1,T2>
    {
        ...
        {
            return Compiler.Compile<Func<T1,T2>>(formula, Definition);
        }
    ...
    public class CompilableLambda<T1,T2,T3>
    {
        ...
        {
            return Compiler.Compile<Func<T1,T2,T3>>(formula, Definition);
        }
    ...
    public class CompilableLambda<T1,T2,T3,T4>
    {
        ...
        {
            return Compiler.Compile<Func<T1,T2,T3,T4>>(formula, Definition);
        }
    ...
    public class CompilableLambda<T1,T2,T3,T4,T5>
    {
        ...
        {
            return Compiler.Compile<Func<T1,T2,T3,T4,T5>>(formula, Definition);
        }
